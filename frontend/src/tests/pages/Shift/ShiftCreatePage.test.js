...
describe("ShiftCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /shift/list", async () => {
        ...
        const shiftStartInput = screen.getByLabelText("Start Time");
        expect(shiftStartInput).toBeInTheDocument();

        const shiftEndInput = screen.getByLabelText("End Time");
        ...
        expect(mockToast).toBeCalledWith("New Shift Created - id: 1 time: 11:00AM - 1:00PM");
