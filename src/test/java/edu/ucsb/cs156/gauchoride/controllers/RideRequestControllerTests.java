...
public class RideRequestControllerTests extends ControllerTestCase {
    ...
    @WithMockUser(roles = { "RIDER" })
    @Test
    public void logged_in_rider_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    @WithMockUser(roles = { "RIDER" })
    @Test
    public void logged_in_rider_cant_get_by_id_when_the_id_does_not_exist() throws Exception {
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void logged_in_admin_can_get_by_id_when_the_id_exists() throws Exception {
        long riderId = currentUserService.getCurrentUser().getUser().getId();
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void admin_tries_to_get_nonexistant_ride_and_gets_right_error_message() throws Exception {
        when(rideReqRepository.findById(eq(7L))).thenReturn(Optional.empty());
    ...
    @WithMockUser(roles = { "DRIVER" })
    @Test
    public void driver_tries_to_get_nonexistant_ride_and_gets_right_error_message() throws Exception {
        when(rideReqRepository.findById(eq(7L))).thenReturn(Optional.empty());
    ...
    public void a_rider_can_post_a_new_ride() throws Exception {
        ...
        MvcResult response = mockMvc.perform(post("/api/ride_request/post?" + params)
    ...
    public void rider_can_delete_their_own_ride() throws Exception {
        ...
        MvcResult response = mockMvc.perform(delete("/api/ride_request?id=15")
                .with(csrf())).andExpect(status().isOk()).andReturn();
    ...
    @WithMockUser(roles = { "RIDER" })
    @Test
    public void rider_tries_to_delete_nonexistant_ride_and_gets_right_error_message() throws Exception {
    ...
    @WithMockUser(roles = { "ADMIN", "RIDER" })
    @Test
    public void admin_tries_to_delete_nonexistant_ride_and_gets_right_error_message() throws Exception {
        when(rideReqRepository.findById(eq(15L))).thenReturn(Optional.empty());
    ...
    public void rider_can_edit_their_own_ride() throws Exception {
        ...
        MvcResult response = mockMvc.perform(put("/api/ride_request?id=67")
    ...
    @WithMockUser(roles = { "RIDER" })
    @Test
    public void rider_tries_to_edit_nonexistant_ride_and_gets_right_error_message() throws Exception {
        long riderId = currentUserService.getCurrentUser().getUser().getId();
        RideRequest ride_edited = RideRequest.builder()
                .riderId(riderId)
                .student("CGaucho")
    ...
    @WithMockUser(roles = { "ADMIN" })
    @Test
    public void admin_tries_to_edit_nonexistant_ride_and_gets_right_error_message() throws Exception {
        long riderId = currentUserService.getCurrentUser().getUser().getId();
        RideRequest ride_edited = RideRequest.builder()
                .riderId(riderId)
                .student("CGaucho")
